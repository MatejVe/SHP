...
print("Finished reading generated strings.")
...
print("Finished creating random strings.")
...
comparative_barplot(
    ...
    title="Compression percentage, zlib compression algorithm",
    filepath="Plots/comparison_graphs/compression_zlib_comparison",
)
